...
### Changed
- Updated to golang 1.26 and Node 24 (including dependencies)
### Added
- Added separate shortcuts for actions
...
## [0.9.8] 2025-11-18
### Fixed
- Fix menu options not working on Linux, fixes issue [#130](https://github.com/scanoss/scanoss.cc/issues/130)
