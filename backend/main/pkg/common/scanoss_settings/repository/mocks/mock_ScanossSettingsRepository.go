...
func (_m *MockScanossSettingsRepository) GetSettingsFileContent() *entities.SettingsFile {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetSettingsFileContent")
	}
...
// MockScanossSettingsRepository_GetSettingsFileContent_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSettingsFileContent'
type MockScanossSettingsRepository_GetSettingsFileContent_Call struct {
	*mock.Call
}

// GetSettingsFileContent is a helper method to define mock.On call
func (_e *MockScanossSettingsRepository_Expecter) GetSettingsFileContent() *MockScanossSettingsRepository_GetSettingsFileContent_Call {
	return &MockScanossSettingsRepository_GetSettingsFileContent_Call{Call: _e.mock.On("GetSettingsFileContent")}
}

func (_c *MockScanossSettingsRepository_GetSettingsFileContent_Call) Run(run func()) *MockScanossSettingsRepository_GetSettingsFileContent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockScanossSettingsRepository_GetSettingsFileContent_Call) Return(_a0 *entities.SettingsFile) *MockScanossSettingsRepository_GetSettingsFileContent_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockScanossSettingsRepository_GetSettingsFileContent_Call) RunAndReturn(run func() *entities.SettingsFile) *MockScanossSettingsRepository_GetSettingsFileContent_Call {
	_c.Call.Return(run)
	return _c
}
