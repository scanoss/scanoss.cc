...
func (_m *MockResultService) GetResults(filters entities.ResultFilter) ([]entities.Result, error) {
...
// MockResultService_GetResults_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetResults'
type MockResultService_GetResults_Call struct {
	*mock.Call
}

// GetResults is a helper method to define mock.On call
//   - filters entities.ResultFilter
func (_e *MockResultService_Expecter) GetResults(filters interface{}) *MockResultService_GetResults_Call {
	return &MockResultService_GetResults_Call{Call: _e.mock.On("GetResults", filters)}
}

func (_c *MockResultService_GetResults_Call) Run(run func(filters entities.ResultFilter)) *MockResultService_GetResults_Call {
...
func (_c *MockResultService_GetResults_Call) Return(_a0 []entities.Result, _a1 error) *MockResultService_GetResults_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResultService_GetResults_Call) RunAndReturn(run func(entities.ResultFilter) ([]entities.Result, error)) *MockResultService_GetResults_Call {
	_c.Call.Return(run)
	return _c
}
