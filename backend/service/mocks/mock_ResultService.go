...
func (_m *MockResultService) GetByPath(path string) (entities.ResultDTO, error) {
	ret := _m.Called(path)
	...
	var r0 entities.ResultDTO
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (entities.ResultDTO, error)); ok {
		return rf(path)
	}
...
func (_c *MockResultService_GetByPath_Call) Return(_a0 entities.ResultDTO, _a1 error) *MockResultService_GetByPath_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResultService_GetByPath_Call) RunAndReturn(run func(string) (entities.ResultDTO, error)) *MockResultService_GetByPath_Call {
	_c.Call.Return(run)
	return _c
}
