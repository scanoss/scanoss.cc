...
func (_m *MockTreeService) GetTree(rootPath string) (entities.Tree, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (entities.Tree, error)); ok {
		return rf(rootPath)
	}
	if rf, ok := ret.Get(0).(func(string) entities.Tree); ok {
		r0 = rf(rootPath)
	} else {
...
func (_c *MockTreeService_GetTree_Call) Return(_a0 entities.Tree, _a1 error) *MockTreeService_GetTree_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTreeService_GetTree_Call) RunAndReturn(run func(string) (entities.Tree, error)) *MockTreeService_GetTree_Call {
	_c.Call.Return(run)
	return _c
}
