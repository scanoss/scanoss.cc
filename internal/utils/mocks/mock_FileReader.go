...
func (_e *MockFileReader_Expecter) ReadFile(filePath interface{}) *MockFileReader_ReadFile_Call {
	return &MockFileReader_ReadFile_Call{Call: _e.mock.On("ReadFile", filePath)}
}

func (_c *MockFileReader_ReadFile_Call) Run(run func(filePath string)) *MockFileReader_ReadFile_Call {
